import type { MotivationName, OutcomeRow } from "../types/negotiation"

export interface MotivationPreset {
  readonly name: MotivationName
  readonly motivationDescription: string
  readonly pitfallDescription: string
}
...
export const MOTIVATION_NAMES: readonly MotivationName[] = MOTIVATION_PRESETS.map(
  (preset) => preset.name,
)

export interface StartingAttitude {
  readonly interest: number
  readonly patience: number
}

export const STARTING_ATTITUDES: Readonly<Record<string, StartingAttitude>> = {
...
export const STARTING_ATTITUDE_NAMES = Object.keys(STARTING_ATTITUDES)

export const DEFAULT_OUTCOMES: readonly OutcomeRow[] = [
  { interestLevel: 5, label: "Yes, and...", details: "" },
  { interestLevel: 4, label: "Yes.", details: "" },
  { interestLevel: 3, label: "Yes, but\u2026", details: "" },
  { interestLevel: 2, label: "No, but\u2026", details: "" },
  { interestLevel: 1, label: "No.", details: "" },
  { interestLevel: 0, label: "No, and\u2026", details: "" },
]

export const RULES_REFERENCE_TEXT = `**Pitfall Used: Automatic failure:
 Both Interest and Patience decrease by 1.**

|Appeal to Motivation: Reason, Intuition, or Presence
|Patience decreases by 1
|Interest increases by 1, Patience decreases by 1
|Interest increases by 1, Patience does not change.

|No Motivation or Pitfall: Reason, Intuition, or Presence
|Interest decreases by 1, Patience decreases by 1
|Patience decreases by 1
|Interest increases by 1, Patience decreases by 1
...
|Uncover Motivation or Pitfall: Reason, Intuition, or Presence
