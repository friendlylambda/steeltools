...
import { checkWebGpuSupport, isModelCached, loadModel } from "../utils/backgroundRemoval"
        ...
        {phase.step === "unsupported" && (
          <>
            ...
            <p css={{ color: colors.text, margin: 0, lineHeight: 1.6 }}>
              ...
              removal (WebGPU). You can still remove your image's background yourself before
              uploading:
            </p>
            <ul
              css={{
